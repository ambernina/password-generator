...
function prompts() {
    ...
    userPassArr = [];
    var lengthTemp = prompt("How long would you like your password to be between 8 and 128 characters?");
...
function password() {
    ...
    for (var i = 0; i < length; i++) {
        userGeneratedPassword += userPassArr[(Math.floor(Math.random() * userPassArr.length))];
...
prompts()
password();
// document.getElementsById("one").addEventListener("click", function(){
